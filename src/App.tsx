...
const quizQuestions = [
  {
    question: "Где должен фокусироваться световой луч в здоровом глазу?",
    options: ["Перед сетчаткой", "На сетчатке", "За сетчаткой"],
    correct: 1,
  },
  {
    question: "Какая линза используется для коррекции близорукости?",
    options: ["Собирающая (выпуклая)", "Рассеивающая (вогнутая)", "Цилиндрическая"],
    correct: 1,
  },
  {
    question: "Что является основной причиной дальнозоркости с точки зрения физики глаза?",
    options: [
      "Слишком длинное глазное яблоко",
      "Слишком короткое глазное яблоко или слабая рефракция",
      "Изменение формы сетчатки",
    ],
    correct: 1,
  },
  {
    question: "При каком нарушении зрения человек плохо видит как вдаль, так и вблизи (при сильной степени)?",
    options: [
      "Только при близорукости",
      "Только при дальнозоркости",
      "При обоих, если степень высокая",
    ],
    correct: 2,
  },
  {
    question: "Какое расстояние от глаз до книги считается оптимальным для профилактики?",
    options: ["15–20 см", "35–40 см", "60–70 см"],
    correct: 1,
  },
  {
    question: "Какой витамин особенно важен для сумеречного зрения?",
    options: ["Витамин C", "Витамин A", "Витамин D"],
    correct: 1,
  },
  {
    question: "Как называется способность хрусталика менять кривизну для фокусировки на разных расстояниях?",
    options: ["Рефракция", "Аккомодация", "Аберрация"],
    correct: 1,
  },
  {
    question: "Что рекомендуют делать каждые 30–40 минут работы за компьютером?",
    options: [
      "Закрыть глаза на 10 минут",
      "Перевести взгляд вдаль на 5–10 минут",
      "Поморгать 3 раза",
    ],
    correct: 1,
  },
      ...
      <section className="mb-10">
        <div className="bg-gradient-to-br from-blue-50 to-pink-50 rounded-3xl p-8">
          ...
          <p className="text-gray-700 leading-relaxed text-base mb-4">
            <strong>Зрение</strong> — это процесс восприятия света, в котором глаз работает как оптическая система.
          </p>
          <p className="text-gray-700 leading-relaxed text-base mb-4">
            Световые лучи проходят через <strong>роговицу</strong> и <strong>хрусталик</strong>, где преломляются (<em>рефракция</em>). Хрусталик меняет кривизну (<em>аккомодация</em>), чтобы сфокусировать лучи точно на сетчатке. Там свет поглощается <strong>фоторецепторами</strong> (палочками и колбочками), преобразуется в нервные сигналы и передаётся в мозг.
          </p>
          <p className="text-gray-700 leading-relaxed text-base">
            Физически качество зрения определяется точностью фокусировки лучей на сетчатке. Если фокус смещается, возникает <strong>аномалия рефракции</strong>.
          </p>
